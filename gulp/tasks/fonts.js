...
export const fontsStyle = () => {
    ...
    fs.readdir(app.path.build.fonts, function(err, fontsFiles) {
        if (fontsFiles) {
            // Перевіряємо чи існує файд стилів для підключення шрифтів
            if (!fs.existsSync(fontsFile)) {
                ...
                console.log("Файл scss/fonts.scss уже існує. Для обновлення потрібно його видалити!");
            }
        }
    });
